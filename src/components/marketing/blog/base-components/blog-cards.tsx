    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex gap-2">
        ...
        <div>
          ...
          <time className="block text-sm text-tertiary">
            {article.publishedAt}
          </time>
        </div>
      </div>
...
export const Simple01Horizontal = ({
  article,
  imageClassName,
}: {
  article: Article;
  ...
  <article className="flex flex-col gap-4 xl:flex-row xl:items-start">
    ...
    >
      <img
        ...
        alt={article.title}
        className={cx(
          "aspect-[1.5] w-full object-cover xl:w-80",
          imageClassName,
        )}
      />
    </a>
...
export const Simple03Horizontal = ({
  article,
  imageClassName,
}: {
  article: Article;
  ...
  <article className="flex flex-col gap-4 xl:flex-row xl:items-start">
    ...
    >
      <img
        ...
        alt={article.title}
        className={cx(
          "aspect-[1.5] w-full object-cover xl:w-91.5",
          imageClassName,
        )}
      />
    </a>
  ...
  <article className="flex flex-col gap-5 lg:flex-row lg:items-start">
    ...
    <div className="flex flex-col items-start gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="line-clamp-2 text-md text-tertiary lg:line-clamp-3">
          {article.summary}
        </p>
      </div>
    ...
    <div className="flex flex-col gap-6 p-5 pb-6 md:p-6">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="line-clamp-2 text-md text-tertiary md:line-clamp-3">
            {article.summary}
          </p>
        </div>
      </div>
...
export const CardFullWidthImage02Vertical = ({
  article,
}: {
  article: Article;
}) => (
...
export const CardFullWidthImage03Vertical = ({
  article,
}: {
  article: Article;
}) => (
...
export const CardFullWidthImage04Vertical = ({
  article,
}: {
  article: Article;
}) => (
...
export const CardFullWidthImage01Horizontal = ({
  article,
}: {
  article: Article;
}) => (
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <Button
            ...
            color="link-gray"
            size="xl"
            className="text-xl font-semibold text-primary md:text-lg"
          >
            {article.title}
          </Button>
...
export const CardFullWidthImage02Horizontal = ({
  article,
}: {
  article: Article;
}) => (
...
export const CardFullWidthImage03Horizontal = ({
  article,
}: {
  article: Article;
}) => (
...
export const CardFullWidthImage04Horizontal = ({
  article,
}: {
  article: Article;
}) => (
